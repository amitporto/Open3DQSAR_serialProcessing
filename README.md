...
IMPORTANT: 1. Summary results are provided in form of Q2LMO and R2Pred. Therefore, keep these options on in the input file.
           2. This program runs with the MM based models (i.e., when the electrostatic fields are calculated with molecular mechanical force fields) and not for QM based models.
